...
<Warning>
**Important**: [Stagehand Agent](/basics/agent/overview) always operate on `stagehand.page`. If you need an agent to work across specific tabs, you'll need to manage page switching manually.
</Warning>
