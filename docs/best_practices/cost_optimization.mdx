...
Cost optimization in Stagehand involves balancing LLM inference costs with browser infrastructure costs. This guide provides practical strategies to reduce your automation expenses.
...
Don't use premium models for simple tasks. See our [evaluation results](https://stagehand.dev/evals) for model performance and cost comparisons across different task types.
...
<Card title="Evaluation Results" icon="chart-line" href="/evals">
...
Cache successful actions to avoid repeated LLM calls. Learn the basics in our [Caching Guide](/best_practices/caching):
...
<CardGroup cols={1}>
<Card title="Caching Guide" icon="database" href="/best_practices/caching">
...
<Card title="Caching Strategies" icon="database" href="/best_practices/caching">
  Reduce costs with smart action caching and observe patterns
</Card>
