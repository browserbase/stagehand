...
Use Google, OpenAI, Anthropic, xAI, DeepSeek, Perplexity, Azure, Ollama, or any other LLM model from [the Vercel AI SDK](https://sdk.vercel.ai/providers) to understand web pages, plan actions, and interact with complex interfaces.
...
Amazon Bedrock, Cohere, all [first class models](/configuration/models#first-class-models), and any model from [the Vercel AI SDK](https://sdk.vercel.ai/providers) is supported.
...
| **Local/offline**         | `ollama/llama3.2`                    | No API costs, full control     |
...
<Tip>
  ...
  feature](/best-practices/caching).
</Tip>
...
- Implement [caching](/best-practices/caching) for repeated patterns
</Accordion>
...
<CardGroup cols={2}>
<Card title="Prompting Guide" href="/best-practices/prompting-best-practices" icon="brain">
  Learn how to prompt LLMs for optimal results
</Card>
<Card title="Run Evals" href="/configuration/evals" icon="flask-vial">
  Test which models work best for your specific use case
</Card>

<Card title="Caching Guide" href="/best-practices/caching" icon="database">
  Cache responses to reduce costs and improve speed
</Card>
<Card
  title="Optimize Costs"
  href="/best-practices/cost-optimization"
  icon="dollar-sign"
>
