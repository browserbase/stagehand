...
<ParamField path="returnAction" type="boolean" optional>
  Whether to return action suggestions along with element information.
...
<ParamField path="backendNodeId" type="number" optional>
  Internal browser identifier (used by Stagehand internals).
</ParamField>
