...
```
`agent` turns high level tasks into **fully autonomous** browser workflows. You can customize the agent by specifying the LLM provider and model, setting custom instructions for behavior, and configuring provider-specific options like API keys.

## Why use `agent()`?

<CardGroup cols={2}>
  <Card title="Natural Language Instructions" icon="wand-magic-sparkles" href="#using-agent">
    Simply describe what you want in plain English. No scripts or selectors needed.
  </Card>
  
  <Card title="Visual Understanding" icon="eye" href="#available-models">
    Sees and understands web interfaces like humans do using computer vision.
  </Card>
  
  <Card title="Autonomous Problem Solving" icon="brain-circuit" href="#best-practices">
    Adapts to obstacles and finds alternative paths to complete tasks.
  </Card>
