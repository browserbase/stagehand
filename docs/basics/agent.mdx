...
<CardGroup cols={2}>
  <Card title="Natural Language Instructions" icon="wand-magic-sparkles">
  ...
  <Card title="Autonomous Problem Solving" icon="brain-circuit">
    Adapts to obstacles and finds alternative paths to complete tasks.
  </Card>
  
  <Card title="Multi-Step Workflows" icon="route">
