...
<Card title="Build your own cache" icon="database">
  Check out the guide guide on how to build your own action cache
</Card>
...
- Log inference to file (see [debugging](/basics/debugging)) to get an LLM trace
...
**Solutions**:
- Check the [supported actions](/basics/act/overview)
- Provide more specific instructions
