...
If this is your **first time using Stagehand**, you should try [Director](https://director.ai) first. It's an agent that allows you to build Stagehand workflows using natural language.
...
<Note>
This quickstart is for **TypeScript**. For **Python**, see the [installation guide](/first_steps/installation).
</Note>
