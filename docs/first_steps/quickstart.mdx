...
The quickest way to start with Stagehand is with our CLI. It scaffolds a ready-to-run Stagehand app with sensible defaults, and an example script.

<Note>
  If you are a Python developer, follow the <a href="/first_steps/installation#python">Python installation instructions</a>.
</Note>
