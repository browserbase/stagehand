...
const AISDKProviders: Record<string, AISDKProvider> = {
  ...
  azure,
  groq,
  cerebras: cerebras as unknown as AISDKProvider,
  togetherai,
  mistral,
  deepseek,
  perplexity,
...
const AISDKProvidersWithAPIKey: Record<string, AISDKCustomProvider> = {
  ...
  azure: createAzure,
  groq: createGroq,
  cerebras: createCerebras as unknown as AISDKCustomProvider,
...
const modelToProviderMap: { [key in AvailableModel]: ModelProvider } = {
  ...
  "cerebras-llama-4-maverick-17b-128e-instruct": "cerebras",
  "cerebras-llama-4-scout-17b-16e-instruct": "cerebras",
  "cerebras-qwen-3-235b-a22b-instruct-2507": "cerebras",
  "cerebras-qwen-3-235b-a22b-thinking-2507": "cerebras",
  "cerebras-qwen-3-32b": "cerebras",
  "cerebras-qwen-3-coder-480b": "cerebras",
