...
# Hardcodes the API URL so we always hit the local Fastify instance.
...
BB_API_KEY="${BB_API_KEY:-${BROWSERBASE_API_KEY:-}}"
BB_PROJECT_ID="${BB_PROJECT_ID:-${BROWSERBASE_PROJECT_ID:-}}"
