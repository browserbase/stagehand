...
export const DEFAULT_ANTHROPIC_ADAPTIVE_EFFORT: Exclude<ThinkingEffort, "none"> = "medium";
...
export function resolveAdaptiveEffort(
  ...
  if (candidate === "xhigh" && !XHIGH_CAPABLE_MODEL_BASES.has(stripModelProvider(modelId))) {
    return "high";
  }
  return candidate;
}
