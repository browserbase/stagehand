...
distribution on PyPI. `just version` applies pending changesets, updates package changelogs,
synchronizes the Python version into `pyproject.toml`, and refreshes `uv.lock`.
