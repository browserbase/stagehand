...
async function testSmartReplySelector() {
  ...
  const testTweets = [
    {
      id: "1",
      content:
        "人工智能正在改变我们的生活方式，今天我体验了最新的AI助手，非常惊艳！",
    },
    { id: "2", content: "比特币今天又创新高，加密货币市场正在复苏。" },
    {
      id: "3",
      content:
        "我们刚刚完成了新一轮融资，这是我创业以来最艰难也最有成就感的时刻。",
    },
    {
      id: "4",
      content: "今天的晚霞太美了，分享给大家！这是我在旅行中拍到的最美景色。",
    },
  ];
  ...
  for (const tweet of testTweets) {
    ...
    if (reply.accountUsername)
      console.log(`使用账号: ${reply.accountUsername}`);
