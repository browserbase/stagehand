...
export default defineBenchTask(
  ...
  {
    default: async ({ debugUrl, sessionUrl, logger, v3, agent }) => {
      try {
    ...
    stagehand_v4: async ({ debugUrl, sessionUrl, logger, v3, agent, page }) => {
      try {
        const goto = page.goto;
        if (typeof goto !== "function") {
          throw new Error("Stagehand v4 page.goto is not available.");
        }
        await goto.call(page, { url: "https://github.com/" });
