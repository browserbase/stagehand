...
export type V4SdkModule = typeof import("@browserbasehq/stagehand-v4-spike-sdk-ts");
 ...
 */
export function resolveV4SdkPath(env: NodeJS.ProcessEnv = process.env): string | undefined {
