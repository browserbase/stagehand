...
HardBench contains 122 browser tasks with precomputed rubrics. Each JSONL row
...
- `EVAL_HARDBENCHMARK_IDS`: comma-separated task IDs or slugs in requested order.
  Explicit selections override tier, sampling, and cap, and may include holdout.
