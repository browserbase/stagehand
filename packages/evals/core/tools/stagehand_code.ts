...
export function buildStagehandCodePromptInstructions(): string {
  return [
    ...
    "Deterministic methods live on the page: await page.goto(url), await page.locator(selector).click(), await page.locator(selector).fill(value), await page.locator(selector).type(text), await page.url(), await page.title(), await page.screenshot().",
