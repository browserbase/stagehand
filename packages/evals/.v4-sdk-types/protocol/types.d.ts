...
import type { StagehandRpcNotificationSchema, StagehandRpcRequestSchema, StagehandMethodSchema, StagehandSendToHostBindingSchema } from "./schema-registry.js";
import type { ActionSchema, ActOptionsSchema, ActResultDataSchema, ActResultSchema, AnthropicModelIdSchema, AnthropicModelNameSchema, AzureEntraIdAuthSchema, AzureModelProviderOptionsSchema, AzureProviderOptionsSchema, BrowserGetVersionResultSchema, BrowserbaseBrowserSettingsSchema, BrowserbaseBrowserSourceSchema, BrowserbaseContextSchema, BrowserbaseFingerprintSchema, BrowserbaseFingerprintScreenSchema, BrowserbaseProxyConfigSchema, BrowserbaseProxyGeolocationSchema, BrowserbaseRegionSchema, BrowserbaseSessionCreateParamsSchema, BrowserbaseViewportSchema, CachingSchema, CerebrasModelIdSchema, CerebrasModelNameSchema, ClientModelReferenceSchema, ClearCookieOptionsSchema, ContextActivePageResultSchema, ContextAddCookiesParamsSchema, ContextAddInitScriptParamsSchema, ContextClearCookiesParamsSchema, ContextClipboardClearParamsSchema, ContextClipboardCopyParamsSchema, ContextClipboardCutParamsSchema, ContextClipboardPasteParamsSchema, ContextClipboardReadTextParamsSchema, ContextClipboardReadTextResultSchema, ContextClipboardTargetSchema, ContextClipboardWriteTextParamsSchema, ContextCloseResultSchema, ContextCookiesParamsSchema, ContextCookiesResultSchema, ContextGetDomainPolicyResultSchema, ContextNewPageParamsSchema, ContextPagesResultSchema, ContextSetActivePageParamsSchema, ContextSetDomainPolicyParamsSchema, ContextSetExtraHTTPHeadersParamsSchema, ContextVoidResultSchema, CookieFilterSchema, CookieParamSchema, CookieRegexSchema, CookieSchema, DomainPolicySchema, EmptyParamsSchema, ExternalProxyConfigSchema, ExtractOptionsSchema, ExtractResultSchema, CustomModelConfigSchema, GoogleModelIdSchema, GoogleModelNameSchema, GoogleServiceAccountAuthSchema, GoogleServiceAccountCredentialsSchema, LocatorClickParamsSchema, LocatorClickResultSchema, LocatorCentroidResultSchema, LocatorCountResultSchema, LocatorCoordinatesSchema, LocatorDescriptorSchema, LocatorFillParamsSchema, LocatorFillResultSchema, LocatorHighlightParamsSchema, LocatorHighlightResultSchema, LocatorHoverResultSchema, LocatorInnerHtmlResultSchema, LocatorInnerTextResultSchema, LocatorInputValueResultSchema, LocatorIsCheckedResultSchema, LocatorIsVisibleResultSchema, LocatorSchema, LocatorScrollToParamsSchema, LocatorScrollToResultSchema, LocatorSelectOptionParamsSchema, LocatorSelectOptionResultSchema, LocatorSendClickEventParamsSchema, LocatorSendClickEventResultSchema, LocatorTextContentResultSchema, LocatorTypeParamsSchema, LocatorTypeResultSchema, LoadStateSchema, LLMGenerateParamsSchema, LLMGenerateResultSchema, LLMAnnotationsSchema, LLMClientToolSchema, LLMImageContentSchema, LLMJsonSchemaResponseFormatSchema, LLMMessageSchema, LLMMessageContentBlockSchema, LLMMessageGenerateParamsSchema, LLMMessageGenerateResultSchema, LLMResponseFormatSchema, LLMRoleSchema, LLMStructuredGenerateParamsSchema, LLMStructuredGenerateResultSchema, LLMTextContentSchema, LLMTextResponseFormatSchema, LLMToolAnnotationsSchema, LLMToolChoiceSchema, LLMToolExecutionSchema, LLMToolIconSchema, LLMToolResultContentSchema, LLMToolUseContentSchema, LLMUsageSchema, MouseButtonSchema, ModelConfigSchema, ModelNameSchema, ModelProviderSchema, GroqModelIdSchema, GroqModelNameSchema, KnownModelConfigSchema, ObserveOptionsSchema, ObserveResultSchema, PageAddInitScriptParamsSchema, PageClickParamsSchema, PageCloseResultSchema, PageCoordinateResultSchema, PageDragAndDropParamsSchema, PageDragAndDropResultSchema, PageEvaluateParamsSchema, PageEvaluateResultSchema, PageGoBackParamsSchema, PageGoForwardParamsSchema, PageGotoParamsSchema, PageHoverParamsSchema, PageIdParamsSchema, PageKeyPressParamsSchema, PageLocatorSchema, PageNavigationOptionsSchema, PageRefSchema, PageReloadParamsSchema, PageScreenshotOptionsSchema, PageScreenshotParamsSchema, PageScreenshotClipSchema, PageScreenshotResultSchema, PageScrollParamsSchema, PageSetExtraHTTPHeadersParamsSchema, PageSetViewportSizeParamsSchema, PageSnapshotParamsSchema, PageSnapshotOptionsSchema, PageTitleResultSchema, PageTypeParamsSchema, PageUrlResultSchema, PageVoidResultSchema, PageWaitForLoadStateParamsSchema, PageWaitForSelectorParamsSchema, PageWaitForSelectorResultSchema, PageWaitForTimeoutParamsSchema, ProxyConfigSchema, RuntimeConfigureParamsSchema, RuntimeConfigureResultSchema, RuntimeLoopbackStatusResultSchema, RgbaColorSchema, StagehandActParamsSchema, StagehandCloseResultSchema, StagehandExtractParamsSchema, StagehandInitParamsSchema, StagehandInitResultSchema, StagehandLogDataSchema, StagehandLogLevelSchema, StagehandLogSchema, StagehandMetricsSchema, StagehandObserveParamsSchema, StagehandPingResultSchema, SnapshotResultSchema, TelemetryConfigSchema, OpenAIModelIdSchema, OpenAIModelNameSchema, VariablePrimitiveSchema, VariablesSchema, VariableValueSchema, VertexModelProviderOptionsSchema, VertexProviderOptionsSchema } from "./schemas.js";
import type { ActRequestSchema, ActResponseSchema, AISDKApiKeyProviderSchema, AnthropicClientOptionsSchema, ApiKeyAuthSchema, ApiKeyClientOptionsSchema, ApiKeyResolvedProviderClientOptionsSchema, AzureApiKeyClientOptionsSchema, AzureEntraClientOptionsSchema, AzureResolvedProviderClientOptionsSchema, BrowserConfigSchema, ClientOptionsBaseSchema, ClientOptionsSchema, ClipboardOptionsSchema, ClipboardPasteOptionsSchema, ErrorResponseSchema, ExtractRequestSchema, ExtractResponseSchema, HistoryEntrySchema, LLMToolSchema, LocalBrowserLaunchOptionsSchema, ModelAuthSchema, ModelProviderOptionsSchema, NavigateOptionsSchema, NavigateRequestSchema, NavigateResponseSchema, NavigateResultSchema, ObserveRequestSchema, ObserveResponseSchema, OllamaResolvedProviderClientOptionsSchema, OpenAIClientOptionsSchema, ReplayActionSchema, ReplayPageSchema, ReplayResponseSchema, ReplayResultSchema, ResolvedProviderClientOptionsSchema, SessionEndResponseSchema, SessionEndRequestSchema, SessionEndResultSchema, SessionHeadersSchema, SessionIdParamsSchema, SessionStartRequestSchema, SessionStartResponseSchema, SessionStartResultSchema, StreamEventLogDataSchema, StreamEventSchema, StreamEventStatusSchema, StreamEventSystemDataSchema, StreamEventTypeSchema, ThinkingEffortSchema, TokenUsageSchema, V3FunctionNameSchema, VertexClientOptionsSchema, VertexResolvedProviderClientOptionsSchema, defaultExtractSchema, pageTextSchema } from "./pending-schemas.js";
...
export type ContextSetExtraHTTPHeadersParams = z.infer<typeof ContextSetExtraHTTPHeadersParamsSchema>;
...
export type ApiKeyResolvedProviderClientOptions = z.infer<typeof ApiKeyResolvedProviderClientOptionsSchema>;
...
export type AzureResolvedProviderClientOptions = z.infer<typeof AzureResolvedProviderClientOptionsSchema>;
...
export type OllamaResolvedProviderClientOptions = z.infer<typeof OllamaResolvedProviderClientOptionsSchema>;
...
export type VertexResolvedProviderClientOptions = z.infer<typeof VertexResolvedProviderClientOptionsSchema>;
