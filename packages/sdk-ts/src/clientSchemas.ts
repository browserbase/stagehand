...
import type { BrowserbaseSessionCreateParams, StagehandLog } from "../../protocol/types.js";
import {
  ActOptionsSchema,
...
type BrowserbaseLaunchOptionsInput = BrowserbaseSessionCreateParams & { apiKey: string };

/**
 * Browserbase launch options use Stagehand's shared, generated Browserbase API contract.
 */
