...
import { MODEL_CATALOG, MODEL_PROVIDERS } from "./modelCatalog.ts";
...
export const OpenAIModelIdSchema = z.enum(MODEL_CATALOG.openai).meta({ id: "OpenAIModelId" });

export const AnthropicModelIdSchema = z
  .enum(MODEL_CATALOG.anthropic)
  .meta({ id: "AnthropicModelId" });

export const GoogleModelIdSchema = z.enum(MODEL_CATALOG.google).meta({ id: "GoogleModelId" });

export const GroqModelIdSchema = z.enum(MODEL_CATALOG.groq).meta({ id: "GroqModelId" });

export const CerebrasModelIdSchema = z.enum(MODEL_CATALOG.cerebras).meta({ id: "CerebrasModelId" });

export const ModelProviderSchema = z.enum(MODEL_PROVIDERS).meta({ id: "ModelProvider" });
