...
Location in the Stagehand repository: `packages/examples/download-financial-statements/typescript`.
...
1.  cd packages/examples/download-financial-statements/typescript
2.  npm install
