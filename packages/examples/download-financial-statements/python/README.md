...
Location in the Stagehand repository: `packages/examples/download-financial-statements/python`.
...
1.  cd packages/examples/download-financial-statements/python
