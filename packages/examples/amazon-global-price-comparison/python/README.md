...
Location in the Stagehand repository: `packages/examples/amazon-global-price-comparison/python`.
...
1. cd packages/examples/amazon-global-price-comparison/python
