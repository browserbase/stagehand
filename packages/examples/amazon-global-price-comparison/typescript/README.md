...
Location in the Stagehand repository: `packages/examples/amazon-global-price-comparison/typescript`.
...
1. cd packages/examples/amazon-global-price-comparison/typescript
2. pnpm install
