...
Location in the Stagehand repository: `packages/examples/company-value-prop-generator/typescript`.
...
1. cd packages/examples/company-value-prop-generator/typescript
2. npm install
