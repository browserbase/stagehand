...
Location in the Stagehand repository: `packages/examples/company-value-prop-generator/python`.
...
1. cd packages/examples/company-value-prop-generator/python
2. pip install python-dotenv stagehand openai pydantic
3. cp .env.example .env # Add your Browserbase API key to .env
4. python main.py
