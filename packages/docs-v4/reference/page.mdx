...
<ParamField path="options.timeoutMs" type="number" optional>
...
<ParamField path="expression" type="string | function">
...
<ParamField path="script" type="InitScriptSource">
...
<ParamField path="wait_until" type="LoadState | str | None" optional>
  The load state to wait for.
</ParamField>

<ParamField path="timeout_ms" type="int | None" optional>
  Maximum wait time in milliseconds.
</ParamField>
...
<ParamField path="button" type="MouseButton | str | None" optional>
  The mouse button to use.
</ParamField>
...
```python
await page.wait_for_load_state("networkidle", timeout_ms=10_000)
```

<ParamField path="state" type="LoadState | str">
  The state to wait for.
</ParamField>
...
<ParamField path="state" type="State | str | None" optional>
  The state to wait for.
</ParamField>
...
<ParamField path="animations" type="Animations | str | None" optional>
  How to handle CSS animations.
</ParamField>

<ParamField path="caret" type="Caret | str | None" optional>
  How to render the text caret.
</ParamField>
...
<ParamField path="scale" type="Scale | str | None" optional>
...
<ParamField path="type" type="ScreenshotType | str | None" optional>
  The image format.
</ParamField>
