...
async def test_stagehand_routes_metrics_and_ai_methods(
    ...
    assert observe_params.options.locator == Locator(selector="main")
    assert observe_params.options.ignore_locators == [Locator(selector="nav")]
    extract_params = next(
    ...
    assert extract_params.options.locator == Locator(selector="main")
    assert extract_params.options.ignore_locators == [Locator(selector=".ad", nth=1)]
