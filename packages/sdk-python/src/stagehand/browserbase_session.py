...
DEFAULT_BROWSERBASE_API_URL = "https://api.browserbase.com"
...
class _OfficialBrowserbaseAPI:
    ...
    async def upload_extension(self, archive: bytes) -> str:
        ...
        async with AsyncBrowserbase(api_key=self._api_key, base_url=self._api_url) as client:
...
def _create_browserbase_session_client(api_key: str, api_url: str) -> _BrowserbaseSessionClient:
    return _BrowserbaseSessionClient(_OfficialBrowserbaseAPI(api_key, api_url))
