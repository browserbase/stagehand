...
class DirectModelConfig(WireModel):
    model_config = ConfigDict(
        extra="forbid",
        validate_by_name=True,
    )
...
class ModelConfig(
    RootModel[Union[DirectModelConfig, BrowserbaseModelConfig, CustomModelConfig]]
):
    root: Union[DirectModelConfig, BrowserbaseModelConfig, CustomModelConfig]
...
class ProviderModelName(RootModel[StrictStr]):
    root: Annotated[
        StrictStr,
        Field(pattern="^(openai|anthropic|google|groq|cerebras)\\/[\\s\\S]{1,}$"),
    ]
    """A provider-qualified model name, such as openai/gpt-5.4"""
