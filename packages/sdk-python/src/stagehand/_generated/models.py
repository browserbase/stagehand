...
class ActOptions(WireModel):
    ...
    """Serializable page or element locator for the action target"""
...
class ElementId(RootModel[StrictStr]):
    root: Annotated[StrictStr, Field(pattern="^(?:p\\d+:)?\\d+-\\d+$")]
...
class ExtractOptions(WireModel):
    ...
    """
    locator: Optional[Locator] = None
    """Serializable page or element locator for the extraction target"""
    cache: Optional[Caching] = None
    """Override the instance-level cache setting for this request"""
...
class FrameIdx(RootModel[StrictInt]):
...
class Locator(LocatorValidation):
    model_config = ConfigDict(
        extra="allow",
        validate_by_name=True,
    )
    ...
    page_idx: Optional[PageIdx] = None
    url: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    ...
    frame_idx: Optional[FrameIdx] = None
    xpath: Optional[StrictStr] = None
    css: Optional[StrictStr] = None
    text: Optional[StrictStr] = None
    react_element_name: Optional[StrictStr] = None
    coordinates: Optional[LocatorCoordinates] = None
...
class LocatorCoordinates(WireModel):
    model_config = ConfigDict(
        extra="forbid",
        validate_by_name=True,
    )
    x: Optional[StrictFloat] = None
    y: Optional[StrictFloat] = None
    top: Optional[StrictFloat] = None
    left: Optional[StrictFloat] = None
    bottom: Optional[StrictFloat] = None
    right: Optional[StrictFloat] = None
...
class ObserveOptions(WireModel):
    ...
    """
    locator: Optional[Locator] = None
    """Serializable page or element locator for the observation target"""
    cache: Optional[Caching] = None
    """Override the instance-level cache setting for this request"""
...
class PageIdx(RootModel[StrictInt]):
    root: Annotated[StrictInt, Field(ge=0, le=9007199254740991)]
...
class TabId(RootModel[StrictInt]):
    root: Annotated[StrictInt, Field(ge=0, le=9007199254740991)]
