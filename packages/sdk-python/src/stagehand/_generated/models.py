...
class AnthropicModelName(RootModel[StrictStr]):
    root: Annotated[
        StrictStr,
        Field(
            pattern="^anthropic\\/(claude-haiku-4-5|claude-haiku-4-5-20251001|claude-sonnet-4-5|claude-sonnet-4-5-20250929|claude-sonnet-4-6|claude-sonnet-5|claude-opus-4-5|claude-opus-4-5-20251101|claude-opus-4-6|claude-opus-4-7|claude-opus-4-8|claude-opus-5|claude-opus-5-5|claude-fable-5|claude-fable-5-1)$"
        ),
    ]
