...
- The v4 module path is `github.com/browserbase/stagehand/packages/sdk-go/v4`, while its source remains in the repository's `packages/sdk-go` directory. Releases from this layout need subdirectory-prefixed Go tags such as `packages/sdk-go/v4.0.0`.
