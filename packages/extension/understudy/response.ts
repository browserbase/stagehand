 ...
 */
function parseHeadersText(headersText: string | undefined): Array<{ name: string; value: string }> {
...
export class Response {
  ...
  constructor(params: {
    ...
    if (params.response.remoteIPAddress && params.response.remotePort !== undefined) {
      this.serverAddress = {
