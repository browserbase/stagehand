...
| `Browser(allowed_domains=[...])` / `prohibited_domains=[...]` | `browser.context.set_domain_policy(allowed_domains=..., blocked_domains=...)` |
...
| `Browser(allowed_domains=...)` | `browser.context.set_domain_policy(allowed_domains=...)` |
