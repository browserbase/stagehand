...
stagehand = Stagehand({"browser": {"type": "local"}})
await stagehand.init()
```
...
<ParamField path="options" type="StagehandClientActOptions | None" optional>
  Options that configure this operation.
</ParamField>

<ParamField path="options.page" type="Page | None" optional>
...
<ParamField path="options.model.api_key" type="str" optional>
  The model provider API key.
</ParamField>

<ParamField path="options.model.base_url" type="str">
  The model provider base URL.
</ParamField>

<ParamField path="options.model.headers" type="dict[str, object]" optional>
  Additional model provider headers.
</ParamField>

  <ParamField path="options.model.model_name" type="ModelName">
    The model identifier.
  </ParamField>
</ParamField>
...
<ParamField path="options.locator.selector" type="str">
  The selector to target.
</ParamField>

  <ParamField path="options.locator.nth" type="int" optional>
    The zero-based index used when the selector matches multiple elements.
  </ParamField>
</ParamField>
...
<ParamField path="options.cache" type="Caching" optional>
  ...
  <ParamField path="options.cache.threshold" type="int" optional>
    The identical-result threshold required before serving a cache hit.
  </ParamField>
</ParamField>
...
<ParamField path="options" type="StagehandClientObserveOptions | None" optional>
  Options that configure this operation.
</ParamField>
...
<ParamField path="options.selector" type="str" optional>
  The selector to target.
</ParamField>

<ParamField path="options.ignore_selectors" type="list[str]" optional>
...
<ParamField path="options" type="StagehandClientExtractOptions | None" optional>
  Options that configure this operation.
</ParamField>
