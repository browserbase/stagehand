...
<ParamField path="browserCdpUrl" type="string" optional>
  CDP WebSocket URL reachable from the browser's extension. Defaults to the browser handle's CDP URL. Set this when the SDK and browser need different addresses, such as across Docker port mappings. Both URLs must connect to the same browser.
</ParamField>
...
<ParamField path="browser_cdp_url" type="str" optional>
  CDP WebSocket URL reachable from the browser's extension. Defaults to the browser handle's CDP URL. Set this when the SDK and browser need different addresses, such as across Docker port mappings. Both URLs must connect to the same browser.
</ParamField>
...
<ParamField path="options.BrowserCDPURL" type="*string" optional>
  CDP WebSocket URL reachable from the browser's extension. Defaults to the browser handle's CDP URL. Set this when the SDK and browser need different addresses, such as across Docker port mappings. Both URLs must connect to the same browser.
</ParamField>
