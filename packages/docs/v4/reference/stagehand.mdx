...
<ResponseField name="result.metadata" type="StagehandResultMetadata">
  ...
  <ResponseField name="result.metadata.cache" type="CacheMetadata" optional>
...
print(product.data, product.metadata.cache.status if product.metadata.cache else None)
```
