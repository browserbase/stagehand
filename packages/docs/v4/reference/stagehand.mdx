...
<ResponseField name="stagehand.browser" type="StagehandBrowser">
  The browser handle this instance was created with. Reach pages and the context through it when you hold the instance but not the handle: `stagehand.browser.context`. Stagehand does not close this browser for you.
</ResponseField>
