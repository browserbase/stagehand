...
<ResponseField name="result.metadata" type="StagehandResultMetadata">
  ...
  <ResponseField name="result.metadata.cacheMetadata" type="CacheMetadata" optional>
    Cache observability for this result; absent when no cache lookup ran.

    <ResponseField name="result.metadata.cacheMetadata.count" type="number" optional>
      Times this cache key has been seen, including this request.
    </ResponseField>

    <ResponseField name="result.metadata.cacheMetadata.threshold" type="number" optional>
      The hit-count threshold in effect for this key.
    </ResponseField>

    <ResponseField name="result.metadata.cacheMetadata.ageMs" type="number" optional>
      Age of the served cache entry in milliseconds; hits only.
    </ResponseField>

    <ResponseField name="result.metadata.cacheMetadata.missReason" type="string" optional>
      Why the cache did not serve this request; misses only.
    </ResponseField>

    <ResponseField name="result.metadata.cacheMetadata.tokensSaved" type="CacheTokenSavings" optional>
      LLM tokens avoided by serving this request from cache; hits only.

      <ResponseField name="result.metadata.cacheMetadata.tokensSaved.inputTokens" type="number">
        Input tokens avoided.
      </ResponseField>

      <ResponseField name="result.metadata.cacheMetadata.tokensSaved.outputTokens" type="number">
        Output tokens avoided.
      </ResponseField>

      <ResponseField name="result.metadata.cacheMetadata.tokensSaved.totalTokens" type="number">
...
<ResponseField name="result.metadata" type="StagehandResultMetadata">
  ...
  <ResponseField name="result.metadata.cache_metadata" type="CacheMetadata" optional>
    Cache observability for this result; absent when no cache lookup ran.

    <ResponseField name="result.metadata.cache_metadata.count" type="int" optional>
      Times this cache key has been seen, including this request.
    </ResponseField>

    <ResponseField name="result.metadata.cache_metadata.threshold" type="int" optional>
      The hit-count threshold in effect for this key.
    </ResponseField>

    <ResponseField name="result.metadata.cache_metadata.age_ms" type="int" optional>
      Age of the served cache entry in milliseconds; hits only.
    </ResponseField>

    <ResponseField name="result.metadata.cache_metadata.miss_reason" type="str" optional>
      Why the cache did not serve this request; misses only.
    </ResponseField>

    <ResponseField name="result.metadata.cache_metadata.tokens_saved" type="CacheTokenSavings" optional>
      LLM tokens avoided by serving this request from cache; hits only.

      <ResponseField name="result.metadata.cache_metadata.tokens_saved.input_tokens" type="int">
        Input tokens avoided.
      </ResponseField>

      <ResponseField name="result.metadata.cache_metadata.tokens_saved.output_tokens" type="int">
        Output tokens avoided.
      </ResponseField>

      <ResponseField name="result.metadata.cache_metadata.tokens_saved.total_tokens" type="int">
        Total tokens avoided.
      </ResponseField>
