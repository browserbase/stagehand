...
<ParamField path="options" type="ClearCookieOptions | None" optional>
  Options that configure this operation.
</ParamField>

<ParamField path="options.name" type="str | re.Pattern[str] | None" optional>
  A cookie name or regular-expression filter.
</ParamField>

<ParamField path="options.domain" type="str | re.Pattern[str] | None" optional>
  A cookie domain or regular-expression filter.
</ParamField>

<ParamField path="options.path" type="str | re.Pattern[str] | None" optional>
  A cookie path or regular-expression filter.
</ParamField>
