...
<Tip>
**🌟 Preview: Browserbase Functions with Secrets** - Deploy your automation code directly on Browserbase using Functions with Secrets. See the [Functions docs](https://docs.browserbase.com/platform/runtime) and reach out to support@browserbase.com to get beta access to Secrets support.
