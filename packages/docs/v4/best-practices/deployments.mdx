...
<Tip>
**🌟 Preview: Browserbase Functions with Secrets** - Deploy your automation code directly on Browserbase, next to the browser session that it drives. See the [Functions docs](https://docs.browserbase.com/platform/runtime) and reach out to hello@browserbase.com to get beta access to Secrets support.

To deploy Stagehand today, you may also use the Vercel guide below.
</Tip>
