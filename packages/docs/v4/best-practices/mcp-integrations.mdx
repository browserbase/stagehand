...
Stagehand also provides experimental [Code Mode integrations](/v4/integrations/overview) that expose a persistent Stagehand browser to CrewAI, Deep Agents, Mastra, and the Vercel AI SDK over MCP. The Eve integration exposes the same tools natively.

<Card title="Stagehand Code Mode integrations" icon="puzzle-piece" href="/v4/integrations/overview">
