...
Stagehand also provides experimental [agent integrations](/v4/integrations/agents) that expose a persistent Stagehand browser to CrewAI, Deep Agents, Mastra, and the Vercel AI SDK over MCP. The Eve integration exposes the same tools natively.

<Card title="Stagehand agent integrations" icon="puzzle-piece" href="/v4/integrations/agents">
