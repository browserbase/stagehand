...
description: "Give your agent a persistent Stagehand browser through MCP or native tools."
---

Stagehand's agent integrations connect coding agents and agent frameworks to a persistent browser. The agent decides what to do, and Stagehand provides the tools to navigate, interact with pages, and read their state.

Each integration exposes three tools: `run`, `snapshot`, and `screenshot`. Use the shared setup below, then follow the guide for your agent or framework in the sidebar.
