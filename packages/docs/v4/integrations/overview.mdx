...
description: "Connect Claude Code, Codex, CrewAI, Deep Agents, Eve, Mastra, pi, or the Vercel AI SDK to a persistent Stagehand browser."
---
...
The Claude Code, Codex, CrewAI, Mastra, Vercel AI SDK, and local Deep Agents examples keep one MCP client session open so the stdio server and browser stay alive. Eve, pi, and Managed Deep Agents bind equivalent tools in-process.
