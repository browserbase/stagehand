...
description: "Connect Claude Code, Codex, CrewAI, Deep Agents, Eve, Flue, Mastra, Pi, or the Vercel AI SDK to a persistent Stagehand browser."
---
...
The Claude Code, Codex, CrewAI, Mastra, Vercel AI SDK, and local Deep Agents examples keep one MCP client session open so the stdio server and browser stay alive. Eve, Flue, Pi, and Managed Deep Agents bind equivalent tools in-process.
