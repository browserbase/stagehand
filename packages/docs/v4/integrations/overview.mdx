...
CrewAI, Eve, Mastra, and the Vercel AI SDK use the shared TypeScript integration server. They require Node.js 24 or newer and pnpm 11.10.0. CrewAI also requires Python 3.11–3.13 and [uv](https://docs.astral.sh/uv/).
