...
description: "Connect Claude Code, Codex, Grok Build, CrewAI, Deep Agents, Eve, Mastra, Pi, or the Vercel AI SDK to a persistent Stagehand browser."
---
