...
description: "Connect Claude Code, Codex, CrewAI, Deep Agents, Eve, Mastra, OpenCode, fx, Pi, or the Vercel AI SDK to a persistent Stagehand browser."
---
...
<CardGroup cols={2}>
  ...
  <Card title="OpenCode" icon="/images/integrations/opencode.svg" href="/v4/integrations/opencode">
    Give an OpenCode SDK session persistent Stagehand browser tools over MCP/stdio.
  </Card>
...
The Claude Code, Codex, OpenCode, CrewAI, Mastra, fx, Vercel AI SDK, and local Deep Agents examples keep one MCP client session open so the stdio server and browser stay alive. Eve, Pi, and Managed Deep Agents bind equivalent tools in-process.
