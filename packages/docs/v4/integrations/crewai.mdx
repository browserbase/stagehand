...
Use CrewAI’s supported tool integration: `MCPServerAdapter` from `crewai-tools`. This is an [official SDK/MCP extension point](https://docs.crewai.com/en/mcp/overview); a separate host plugin marketplace is not required.
