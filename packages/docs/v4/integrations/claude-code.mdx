...
Requires Node.js 24+ and local Chrome. To use Browserbase, export `BROWSERBASE_API_KEY` before starting Claude Code. Optional `STAGEHAND_*` settings are described below.
