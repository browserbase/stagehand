...
Use Vercel AI SDK’s supported tool integration: `createMCPClient` from `@ai-sdk/mcp`. This is an [official SDK/MCP extension point](https://ai-sdk.dev/docs/ai-sdk-core/mcp-tools); a separate host plugin marketplace is not required.
