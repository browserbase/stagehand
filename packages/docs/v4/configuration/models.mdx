...
<Accordion title="OpenAI-compatible URLs">

The TypeScript, Python, and Go SDKs include a helper for any Chat Completions endpoint. No provider SDK is required. Pass the gateway's model id, base URL, and API key.
...
from stagehand import open_ai_compatible
