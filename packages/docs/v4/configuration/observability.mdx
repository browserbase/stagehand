...
<Note>
The records you capture depend on the level. TypeScript and Python can raise it to `debug` for the fullest timeline; Go exposes no level and receives `info` and above.
</Note>
