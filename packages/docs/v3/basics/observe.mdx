...
<CardGroup cols={2}>
  ...
  <Card title="Cache" icon="database" href="/v3/best-practices/server-caching">
...
For how the cache works, tuning the validation threshold, and best practices, see the [Server Caching](/v3/best-practices/server-caching) guide.
...
<Card title="Complete caching guide" icon="database" href="/v3/best-practices/server-caching">
...
<CardGroup cols={2}>
  ...
  <Card title="Caching actions" icon="bolt" href="/v3/best-practices/server-caching">
