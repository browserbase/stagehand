...
We have two types of evals:
1. **LLM-based Evals** - These are evals that test the underlying functionality of Stagehand's AI primitives.
2. **Agent Benchmarks** - These are evals that test the performance of the agents against public benchmarks.
