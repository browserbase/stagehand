...
---
<CardGroup cols={1}>
<Card title="Page" icon="browser" href="/basics/page">
...
```typescript
await page.click(x: number, y: number, options?: ClickOptions): Promise<void>
```
...
<ParamField path="button" type="string" optional>
  Mouse button to use.
