...
type ModelConfiguration =
  | string  // Format: "provider/model" (e.g., "openai/gpt-4o", "anthropic/claude-sonnet-4-20250514")
  | {
...
<ParamField path="model" type="ModelConfiguration" optional>
  ...
  - A string in the format `"provider/model"` (e.g., `"openai/gpt-4o"`, `"anthropic/claude-sonnet-4-20250514"`)
  ...
  <Expandable title="Model Configuration Object">
    <ParamField path="modelName" type="string" required>
      The model name (e.g., "gpt-4o", "claude-sonnet-4-20250514", "gemini-2.5-flash")
    </ParamField>
