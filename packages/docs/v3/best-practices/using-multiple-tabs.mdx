...
<Warning>
**Important**: [Stagehand Agent](/basics/agent) will always operate on the active page. If you need an agent to work across specific tabs, you'll need to manage page switching manually.
</Warning>
