...
- **Auto-caching**: Stagehand v3 now automatically caches actions and agent steps using the [file system cache](/v3/best-practices/local-caching).
...
- [Best Practices](/v3/best-practices/server-caching)
