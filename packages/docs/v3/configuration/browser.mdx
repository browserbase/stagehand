...
For performance optimization and resilience features like action caching, self-healing, DOM settling, and experimental features, see the Advanced Configuration guide:

<Card title="Advanced Configuration" icon="sliders" href="/v3/configuration/advanced">
  Configure caching, self-healing, DOM timeouts, and experimental features for optimal performance
</Card>
