...
Understand web pages, plan actions, and interact with complex interfaces with Google, OpenAI, Anthropic, MiniMax, xAI, DeepSeek, Perplexity, Azure, Ollama, the [Vercel AI Gateway](https://vercel.com/docs/ai-gateway), or any other LLM model from [the Vercel AI SDK](https://sdk.vercel.ai/providers).
...
Available models: `MiniMax-M3` (recommended, 512K context with vision), `MiniMax-M2.7` (256K context), `MiniMax-M2.7-highspeed` (optimized for speed), `MiniMax-M2.5` (204K context), `MiniMax-M2.5-highspeed` (204K context, optimized for speed).
