...
<Callout icon="sparkles" color="#FFC107" iconType="regular">
  **Model Gateway** — Use your Browserbase API key to access top models from OpenAI, Anthropic, and Google. One key, one bill, no provider accounts needed. [Read the blog](#model-gateway)
</Callout>
