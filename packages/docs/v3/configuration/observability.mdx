...
<CardGroup cols={2}>
<Card title="Debugging Tips" icon="bug" href="/v3/best-practices/history">
  Learn about history tracking and debugging workflows.
</Card>
<Card title="LLM Inference Debugging" icon="microscope" href="/v3/configuration/logging#llm-inference-debugging">
  Save complete LLM request/response dumps to disk for offline analysis.
</Card>
</CardGroup>
